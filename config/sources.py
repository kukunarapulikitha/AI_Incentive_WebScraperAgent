...
SOURCES: dict[str, SourceConfig] = {
    ...
    "rewiring_ira": SourceConfig(
        ...
        notes="IRA HOMES + HEAR rebates served from static_records.json (LLM rate-limit-proof).",
    ),
    ...
    "my_safe_fl_home": SourceConfig(
        ...
        notes="Static — hurricane mitigation grant up to $10K, well-documented program.",
    ),
    ...
    "fema_mitigation": SourceConfig(
        ...
        notes="Static — HMGP + BRIC curated in static_records.json (FEMA pages don't expose program $ caps).",
    ),
    ...
    "doe_weatherization": SourceConfig(
        ...
        default_state="USA",
        default_administrator="U.S. Department of Energy",
        notes="Static — federal WAP details curated in static_records.json.",
    ),
}
